function animationEndEventName() {
    ...
    for (t in n) if (n.hasOwnProperty(t) && void 0 !== e.style[t]) return n[t]
}
...
!function (t) {
    ...
    return function t(e, n, r) {
        ...
        1: [function (t, e, n) {
            !function (t) {
                ...
                var r = function () {
                    "use strict";
                    var r, i, o, s, a, u = "linear", h = 1e3 / 60, f = Date.now ? Date.now : function () {
                        return +new Date
                    }, l = SHIFTY_DEBUG_NOW || f;
                    ...
                    function _(t, e, n, i, o, s, a) {
                        var u, h = (t - s) / o;
                        for (u in e) e.hasOwnProperty(u) && (e[u] = w(n[u], i[u], r[a[u]], h));
                        return e
                    }
                    ...
                    function m(t, e) {
                        var n = x.prototype.filter, r = t._filterArgs;
                        c(n, function (i) {
                    ...
                    function y(t, e) {
                        var n = {};
                        return c(t, "string" == typeof e ? function (t) {
                            n[t] = e
                        } : function (t) {
                            n[t] || (n[t] = e[t] || u)
                        }), n
                    ...
                    return i = "undefined" != typeof window && (window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || window.mozCancelRequestAnimationFrame && window.mozRequestAnimationFrame) || setTimeout, x.prototype.tween = function (t) {
                        ...
                        t = t || {}, this._configured = !0, this._pausedAtTime = null, this._start = t.start || p, this._step = t.step || p, this._finish = t.finish || p, this._duration = t.duration || 500, this._currentState = t.from || this.get(), this._originalState = this.get(), this._targetState = t.to || this.get(), this._timestamp = l();
                        var e = this._currentState, n = this._targetState;
                        return g(n, e), this._easing = y(e, t.easing || u), this._filterArgs = [e, this._originalState, n, this._easing], m(this, "tweenCreated"), this
                        ...
                        this._isPaused && (this._timestamp += l() - this._pausedAtTime), this._isPaused = !1, this._isTweening = !0;
                        var t = this;
                ...
                r.shallowCopy(r.prototype.formula, {
                    ...
                    function t(t, e, n, r, i, o) {
                        ...
                        return a = 1 - (h = 3 * e) - (u = 3 * (r - e) - h), f = 1 - (p = 3 * n) - (l = 3 * (i - n) - p), s = function (t, e) {
                            var n, r, i, o, s, f, l;
                            for (i = t, f = 0; f < 8; f++) {
                                if (d(o = c(i) - t) < e) return i;
                                if (d(s = (3 * a * (l = i) + 2 * u) * l + h) < 1e-6) break;
                                i -= o / s
                            }
                    ...
                    r.setBezierFunction = function (e, n, i, o, s) {
                        var a, u, h, f, l = (a = n, u = i, h = o, f = s, function (e) {
                    ...
                    var t = new r;
                    t._filterArgs = [], r.interpolate = function (e, n, i, o) {
                        var s = r.shallowCopy({}, e), a = r.composeEasingObject(e, o || "linear");
                        t.set({});
                        var u = t._filterArgs;
                        u.length = 0, u[0] = s, u[1] = e, u[2] = n, u[3] = a, r.applyFilter(t, "tweenCreated"), r.applyFilter(t, "beforeTween");
                        var h, f, l, p, c, d = (h = e, f = s, l = n, p = i, c = a, r.tweenProps(p, f, h, l, 1, 0, c));
                        return r.applyFilter(t, "afterTween"), d
                    }
                }(), function (t) {
                    var e = /(\d|\-|\.)/, n = /([^\-0-9\.]+)/g, r = /[0-9.\-]+/g,
                        i = new RegExp("rgb\\(" + r.source + /,\s*/.source + r.source + /,\s*/.source + r.source + "\\)", "g"),
                        o = /^.*\(/, s = /#([0-9]|[a-f]){3,6}/gi, a = "VAL", u = [];

                    function h(e) {
                        t.each(e, function (t) {
                            var n = e[t];
                            "string" == typeof n && n.match(s) && (e[t] = c(s, n, f))
                        })
                    }
                    ...
                    function f(t) {
                        var e = function (t) {
                            ...
                            return l[0] = p(t.substr(0, 2)), l[1] = p(t.substr(2, 2)), l[2] = p(t.substr(4, 2)), l
                        }(t);
                    ...
                    function c(t, e, n) {
                        var r = e.match(t), i = e.replace(t, a);
                        if (r) for (var o, s = r.length, u = 0; u < s; u++) o = r.shift(), i = i.replace(a, n(o));
                        return i
                    }

                    function d(t) {
                        for (var e = t.match(r), n = e.length, i = t.match(o)[0], s = 0; s < n; s++) i += parseInt(e[s], 10) + ",";
                    ...
                    function g(r) {
                        ...
                        return t.each(r, function (t) {
                            ...
                            if ("string" == typeof h) {
                                var f = v(h);
                                i[t] = {
                                    formatString: (o = h, s = o.match(n), s ? (1 === s.length || o[0].match(e)) && s.unshift("") : s = ["", ""], s.join(a)),
                                    chunkNames: function (t, e) {
                                        u.length = 0;
                                        var n, r = t.length;
                                        for (n = 0; n < r; n++) u.push("_" + e + "_" + n);
                                        return u
                                    }(f, t)
                                }
                            }
                    ...
                    function _(e, n) {
                        t.each(n, function (t) {
                            for (var r = v(e[t]), i = r.length, o = 0; o < i; o++) e[n[t].chunkNames[o]] = +r[o];
                            delete e[t]
                        })
                    }
                    ...
                    function w(e, n) {
                        t.each(n, function (t) {
                            ...
                            r = function (t, e) {
                                for (var n = t, r = e.length, i = 0; i < r; i++) n = n.replace(a, +e[i].toFixed(4));
                                return n
                    ...
                    t.prototype.filter.token = {
                        tweenCreated: function (t, e, n, r) {
                            ...
                            var o, s;
                            o = i, s = this._tokenData, t.each(s, function (t) {
                                for (var e = s[t].chunkNames, n = e.length, r = o[t].split(" "), i = r[r.length - 1], a = 0; a < n; a++) o[e[a]] = r[a] || i;
                                delete o[t]
                            }), _(e, this._tokenData), _(n, this._tokenData), _(r, this._tokenData)
                        }, afterTween: function (e, n, r, i) {
                            var o, s;
                            w(e, this._tokenData), w(n, this._tokenData), w(r, this._tokenData), o = i, s = this._tokenData, t.each(s, function (t) {
                                for (var e = s[t].chunkNames, n = e.length, r = "", i = 0; i < n; i++) r += " " + o[e[i]], delete o[e[i]];
                                o[t] = r.substr(1)
                            })
                        }
                    }
            ...
            var r = t("./progress"), i = t("./utils"), o = function (t, e) {
            ...
            (o.prototype = new r).constructor = o, o.prototype._pathString = function (t) {
                var e = 50 - t.strokeWidth / 2;
                return i.render(this._pathTemplate, {radius: e, "2radius": 2 * e})
            ...
            var r = t("./line"), i = t("./circle"), o = t("./square"), s = t("./path");
            e.exports = {Line: r, Circle: i, Square: o, Path: s}
        }, {"./circle": 2, "./line": 3, "./path": 5, "./square": 7}], 5: [function (t, e, n) {
            var r = t("shifty"), i = t("./utils"),
                o = {easeIn: "easeInCubic", easeOut: "easeOutCubic", easeInOut: "easeInOutCubic"}, s = function (t, e) {
                    e = i.extend({
                    ...
                    this._path.style.strokeDasharray = n + " " + n, this._path.style.strokeDashoffset = n
                };
            s.prototype.value = function () {
                var t = this._getComputedDashOffset(), e = this._path.getTotalLength();
                ...
                i.isFunction(e) && e(this._calculateTo(t, "linear"), this._opts.attachment || this)
                ...
                var h = this._getComputedDashOffset(), f = this._progressToOffset(t), l = this;
                this._tweenable = new r, this._tweenable.tween({
                    from: i.extend({offset: h}, u.from),
                    to: i.extend({offset: f}, u.to),
                    duration: e.duration,
                    easing: a,
                    step: function (t) {
                ...
                return n.from && n.to ? {from: n.from, to: n.to} : {
            ...
            var r = t("./path"), i = t("./utils"), o = "Object is destroyed", s = function t(e, n) {
                ...
                if (0 !== arguments.length) {
                    this._opts = i.extend({
                        ...
                        trailWidth: null,
                        fill: null,
                        text: {autoStyle: !0, color: null, value: "", className: "progressbar-text"}
                    }, n, !0);
                    ...
                    this._container = o, this._container.appendChild(s.svg), this.text = null, this._opts.text.value && (this.text = this._createTextElement(this._opts, this._container), this._container.appendChild(this.text));
                    var a = i.extend({attachment: this}, this._opts);
                    this._progressPath = new r(s.path, a), this.svg = s.svg, this.path = s.path, this.trail = s.trail
                }
            };
            s.prototype.animate = function (t, e, n) {
                ...
                if (null === this._progressPath) throw new Error(o);
                if (null === this.text) return this.text = this._createTextElement(this._opts, this._container), void this._container.appendChild(this.text);
                this.text.removeChild(this.text.firstChild), this.text.appendChild(document.createTextNode(t))
            ...
            e.exports = {
                extend: function t(e, n, r) {
                    ...
                    for (var i in n) if (n.hasOwnProperty(i)) {
                        var s = e[i], a = n[i];
                        r && o(s) && o(a) ? e[i] = t(s, a, r) : e[i] = a
                    }
                    return e
                }, render: function (t, e) {
                    var n = t;
                    for (var r in e) if (e.hasOwnProperty(r)) {
                        var i = e[r], o = new RegExp("\\{" + r + "\\}", "g");
                        n = n.replace(o, i)
                    }
                    return n
                    ...
                    t.style[e] = n
                }, capitalize: i, isString: function (t) {
    ...
    function e() {
        if (o.length) {
            var e = 0, i = t.map(o, function (t) {
                var e = t.data.selector, n = t.$element;
                return e ? n.find(e) : n
            });
            for (n = n || (d = void 0, g = void 0, _ = void 0, (_ = {
                height: a.innerHeight,
                width: a.innerWidth
            }).height || ((d = s.compatMode) || !t.support.boxModel) && (_ = {
                height: (g = "CSS1Compat" === d ? u : s.body).clientHeight,
                width: g.clientWidth
            }), _), r = r || {
                top: a.pageYOffset || u.scrollTop || s.body.scrollTop,
                left: a.pageXOffset || u.scrollLeft || s.body.scrollLeft
            }; e < o.length; e++) if (t.contains(u, i[e][0])) {
                var h = t(i[e]), f = h[0].offsetHeight, l = h[0].offsetWidth, p = h.offset(), c = h.data("inview");
                if (!r || !n) return;
                p.top + f > r.top && p.top < r.top + n.height && p.left + l > r.left && p.left < r.left + n.width ? c || h.data("inview", !0).trigger("inview", [!0]) : c && h.data("inview", !1).trigger("inview", [!1])
            }
        }
        var d, g, _
    }

    var n, r, i, o = [], s = document, a = window, u = s.documentElement;
    ...
    var t = document.querySelectorAll(".mh-progress");
    Array.prototype.forEach.call(t, function (e, n) {
        var r, i = e.getAttribute("data-progress");
        r = $(e).hasClass("progress-line") ? new ProgressBar.Line(t[n], {
            strokeWidth: 5,
            easing: "easeInOut",
            trailWidth: 5,
            text: {value: "0", style: {}},
